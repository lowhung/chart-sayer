...
class PositionCommands(commands.Cog):
    ...
    @app_commands.command(name="positions", description="List your active positions")
    ...
    @app_commands.command(name="position", description="Get details of a position")
    @app_commands.describe(position_id="The ID of the position")
    async def position(self, interaction: discord.Interaction, position_id: str):
    ...
    @app_commands.command(name="update", description="Update a position")
    ...
    @app_commands.command(name="stop", description="Stop tracking a position")
    @app_commands.describe(position_id="The ID of the position to stop tracking")
    async def stop_position(self, interaction: discord.Interaction, position_id: str):
    ...
    @app_commands.command(name="summary", description="Get a summary of your positions")
    ...
    @app_commands.command(name="create", description="Create a new position")
    @app_commands.describe(
    ...
    async def on_message(self, message):
        ...
        if position:
            ...
            await message.channel.send(
                ...
                f"Use `/position {position.id}` to see details."
            )
